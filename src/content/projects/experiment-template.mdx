...
# EXPERIMENT TEMPLATE
# =============================================================================
# Use projectType: "experiment" when:
#   - You're learning something new ("I wanted to try X")
#   - It's a prototype or proof of concept
#   - The goal was exploration, not a finished product
#   - You want to share what you learned, not what you shipped
#
...
projectType: "experiment"    # Options: side-project, case-study, experiment
status: "completed"          # Options: completed, wip, archived (or leave empty)
timeSpent: "A few evenings"  # Casual time context
