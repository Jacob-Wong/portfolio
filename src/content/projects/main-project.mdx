...
repoUrl: "https://github.com/{{GITHUB_USERNAME}}/task-orchestrator"
highlights:
...
**Decision**: Implemented a hybrid approach—workers poll for jobs but receive push notifications for high-priority tasks.
